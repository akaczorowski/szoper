package pl.akac.android.szoper.common.listener;
...
public class RecyclerViewItemClickSupport {
  ...
  private OnItemTouchListener mOnItemToucheListener;

  private View.OnTouchListener mOnTouchListener = new View.OnTouchListener() {
    @Override
    public boolean onTouch(View v, MotionEvent event) {
      if (mOnItemToucheListener != null) {
        RecyclerView.ViewHolder holder = mRecyclerView.getChildViewHolder(v);
        return mOnItemToucheListener.onItemTouch(mRecyclerView, holder.getAdapterPosition(), v, event);
      }
      return false;
    }
  };
  ...
  public static RecyclerViewItemClickSupport addTo(RecyclerView view) {
    RecyclerViewItemClickSupport support = (RecyclerViewItemClickSupport) view.getTag(
  ...
  public RecyclerViewItemClickSupport setOnItemTouchListener(OnItemTouchListener listener) {
    mOnItemToucheListener = listener;
    return this;
  }
  ...
  public interface OnItemTouchListener {
    boolean onItemTouch(RecyclerView recyclerView, int position, View v, MotionEvent event);
  }
}
